...
`github.com/owner/repo` → `~/.cache/checkouts/github.com/owner/repo`
...
```bash
bash checkout.sh owner/repo --path-only
bash checkout.sh github.com/owner/repo --path-only
bash checkout.sh https://github.com/owner/repo --path-only
```
