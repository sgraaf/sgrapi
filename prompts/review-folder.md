---
description: Review specific folders/files (snapshot, not diff)
---
# Review Guidelines
...
Review the code in the following paths: $@. This is a snapshot review (not a diff). Read the files directly in these paths and provide prioritized, actionable findings.
